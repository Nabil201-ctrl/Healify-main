                    ...
                    {unreadCount > 0 && (
                        <>
                            ...
                            <TouchableOpacity onPress={markAllRead} style={styles.markAllBtn}>
                                <Text style={[styles.markAllText, { color: colors.tint }]}>Mark all</Text>
                            </TouchableOpacity>
                        </>
                    )}
                </View>
                    ...
                    renderItem={({ item }) => (
                        ...
                        >
                            <View style={[
                                ...
                                { backgroundColor: `${item.color}${item.read ? '10' : '20'}` }
                            ]}>
                                <Ionicons
                                    name={item.icon as any}
                                    size={22}
                                    color={item.read ? `${item.color}70` : item.color}
                                />
                            </View>
                            ...
                            <View style={styles.textContainer}>
                                <View style={styles.itemHeader}>
                                    ...
                                    <Text style={[styles.itemTime, { color: isDark ? '#374151' : '#d1d5db' }]}>
                                        {item.time}
                                    </Text>
                                </View>
                                <Text
